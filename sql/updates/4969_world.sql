...
INSERT INTO `creature` (`id`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`) VALUES('12018','409','761.02','-1179.49','-118.89', '2.96','604800');
...
INSERT INTO `creature_template`(`entry`, `modelid_A`, `modelid_H`, `name`, `minlevel`, `maxlevel`, `minhealth`, `maxhealth`, `faction_A`, `faction_H`, `AIName`) VALUES('100300', '169', '169', 'Hot Coal', '73', '73', '1', '1', '35', '35', 'NullCreatureAI');
DELETE FROM `creature_scripts` WHERE `entryorguid` = 100300;
INSERT INTO `creature_scripts` VALUES (100300, 'Mob_Hot_Coal');
insert into `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) values('120453','100300','409','1','0','0','736.712','-1176.58','-118.954','0.562596','25','0','0','1','0','0','0');
