...
UPDATE spell_affect SET SpellFamilyMask = 0x7FFFFFFFFFFFFF where entry = 17118 AND effectId = 1;

#Sanctified Seals should apply on Seal of the Crusader
UPDATE spell_affect SET SpellFamilyMask = 4398214283776 WHERE entry = 32043;

#Healing Grace resist dispell effect should affect every spell
UPDATE spell_affect SET SpellFamilyMask = 0x7FFFFFFFFFFFFF where entry = 29187;

#Stoicism resist dispell effect should affect every spell
UPDATE spell_affect SET SpellFamilyMask = 0x7FFFFFFFFFFFFF where entry = 31844;
