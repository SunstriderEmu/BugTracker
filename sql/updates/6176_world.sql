...
UPDATE creature_template SET equipment_id = 91487 WHERE entry = 17798;
...
UPDATE creature_template SET equipment_id = 91493 WHERE entry = 17800;
...
#Sanguinar :
REPLACE INTO creature_equip_template VALUES (91471,40676,40867,0,1026,1540,0,21,14,0);
UPDATE creature_template SET equipment_id = 91471 WHERE entry = 20060;

#Thaladred :
REPLACE INTO creature_equip_template VALUES (91472,41560,0,0,3842,0,0,13,0,0);
UPDATE creature_template SET equipment_id = 91472 WHERE entry = 20064;

#Grande Astromancienne Capernian :
REPLACE INTO creature_equip_template VALUES (91473,41895,0,0,772,0,0,10,0,0);
UPDATE creature_template SET equipment_id = 91473 WHERE entry = 20062;

#Telonicus :
REPLACE INTO creature_equip_template VALUES (91474,41872,0,0,260,0,0,16,0,0);
UPDATE creature_template SET equipment_id = 91474 WHERE entry = 20063; 

#Mennu le traitre :
REPLACE INTO creature_equip_template VALUES (91475,32780,0,0,1026,0,0,21,0,0);
UPDATE creature_template SET equipment_id = 91475 WHERE entry = 17941;

#Conducteur d'esclave glissecroc :
REPLACE INTO creature_equip_template VALUES (91476,8747,0,0,1538,0,0,17,0,0);
UPDATE creature_template SET equipment_id = 91476 WHERE entry = 17959;

#Ouvrier marchefriche :
REPLACE INTO creature_equip_template VALUES (91477,19234,0,0,258,0,0,21,0,0);
UPDATE creature_template SET equipment_id = 91477 WHERE entry = 17964;

#Esclave marchefriche :
REPLACE INTO creature_equip_template VALUES (91478,19234,0,0,258,0,0,21,0,0);
UPDATE creature_template SET equipment_id = 91478 WHERE entry = 17963;
