-- delete duplicate John!
DELETE FROM creature WHERE guid = 96276;

DELETE FROM `game_event` WHERE `entry`=60;
INSERT INTO `game_event` (`entry`, `start_time`, `end_time`, `occurence`, `length`, `description`, `world_event`) VALUES
(60, '2018-01-01 07:00:00', '2020-01-01 08:00:00', 1440, 60, 'Childeren of Goldshire', 0);
...
(78705, 78705, 0, 0,   515), -- Cameron 79638
(78705, 78706, 3, 230, 515), -- John 79639
(78705, 78707, 3, 180, 515), -- Dana 79640
(78705, 78708, 3, 130, 515), -- Jose 79641
(78705, 78709, 3, 310, 515), -- Lisa 79642
(78705, 78710, 3, 50,  515); -- Aaron 79643
...
UPDATE `creature` SET `position_x`=-9373.521, `position_y`=-67.71767, `position_z`=69.201965, `orientation`=1.117011 WHERE `guid`=78709;
UPDATE `creature` SET `position_x`=-9374.94, `position_y`=-62.51654, `position_z`=69.201965, `orientation`=5.201081 WHERE `guid`=78710;
UPDATE `creature` SET `position_x`=-9371.013, `position_y`=-71.20811, `position_z`=69.201965, `orientation`=1.937315 WHERE `guid`=78708;
UPDATE `creature` SET `position_x`=-9368.419, `position_y`=-66.47543, `position_z`=69.201965, `orientation`=3.141593 WHERE `guid`=78705;
UPDATE `creature` SET `position_x`=-9372.376, `position_y`=-65.49946, `position_z`=69.201965, `orientation`=4.206244 WHERE `guid`=78707;
UPDATE `creature` SET `position_x`=-9377.477, `position_y`=-67.8297, `position_z`=69.201965, `orientation`=0.296706 WHERE `guid`=78706;