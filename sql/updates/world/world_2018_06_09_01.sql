...
-- [TC] DB/Quest: Quest Emotes (Elwynn Forest & Westfall)
...
UPDATE `quest_template` SET `PrevQuestId`=1363 WHERE `entry`=1364;
...
UPDATE `quest_template` SET `PrevQuestId`=7648 WHERE `entry`=7643;
...
UPDATE `quest_template` SET `PrevQuestId`=1947 WHERE `entry`=1948;
...
-- Quest "Alther's Mill"
UPDATE `quest_template` SET `PrevQuestId`=2281 WHERE `entry`=2282;
