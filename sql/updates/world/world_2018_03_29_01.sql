...
REPLACE INTO `trinity_string` (entry, content_default) VALUES (11901, 'Movement type: %s');

DELETE FROM `command` WHERE `name`='reload creature_movement_override';
INSERT INTO `command` (`name`,`security`,`help`) VALUES
('reload creature_movement_override',4,'Syntax: .reload creature_movement_override\nReload creature_movement_override table.');