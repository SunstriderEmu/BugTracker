...
-- 
UPDATE `gameobject_template` SET `AIName`="SmartGameObjectAI" WHERE `entry` IN (164871, 175080, 176495);
DELETE FROM `smart_scripts` WHERE `entryorguid` IN (164871, 175080, 176495, 17508000, 17649500) AND `source_type` IN (1, 9);
