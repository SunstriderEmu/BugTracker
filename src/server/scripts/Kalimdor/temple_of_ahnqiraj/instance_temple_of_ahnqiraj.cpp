...
public:
    ...
    {
        return new instance_temple_of_ahnqiraj_script(map);
    }

    struct instance_temple_of_ahnqiraj_script : public InstanceScript
    {
        instance_temple_of_ahnqiraj_script(Map *map) : InstanceScript(map) { Initialize(); };
