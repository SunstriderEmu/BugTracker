...
public:
    ...
    class boss_skeramAI : public ScriptedAI
    {
        public:
        ...
        void DoSplit(int atPercent /* 75 50 25 */)
        {
                ...
                if (targetpl->GetTypeId() == TYPEID_PLAYER)
                {
                    ...
                    if (grp)
                    {
                        for (int ici = 0; ici < TARGETICONCOUNT; ici++)
                        {
                            ...
                            grp->SetTargetIcon(ici, ObjectGuid::Empty, ObjectGuid::Empty);
                        }
                    }
                    break;
                }
            ...
            ((boss_skeram::boss_skeramAI*)Image1->AI())->IsImage = true;
            ((boss_skeram::boss_skeramAI*)Image2->AI())->IsImage = true;
