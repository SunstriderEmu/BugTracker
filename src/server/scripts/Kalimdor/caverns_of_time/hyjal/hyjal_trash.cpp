...
float AllianceOverrunWP[55][3]=//waypoints in the alliance base used in the end in the cleaning wave
{
    ...
    {4982.92f, -1753.70f, 1330.69f},//2 end
    ...
    {4983.25f, -1857.40f, 1320.48f},//32 25
    {4981.51f, -1883.70f, 1322.34f},//31 26
...
void hyjal_trashAI::UpdateAI(const uint32 diff)
{
    ...
    if(me->GetEntry() == GHOUL && !cannibalism)
    {
...
public:
    ...
    class mob_giant_infernalAI : public hyjal_trashAI
    {
        public:
        ...
        override {
            ...
            if (!meteor)
            {
                ...
                if(trigger)
                {
                    ...
                    trigger->CastSpell(me,SPELL_METEOR, TRIGGERED_FULL_MASK);
                }
...
public:
    ...
    class mob_abominationAI : public hyjal_trashAI
    {
        public:
        ...
        override {
            ...
            if(!me->HasAuraEffect(SPELL_DISEASE_CLOUD,0))
...
public:
    ...
    class mob_ghoulAI : public hyjal_trashAI
    {
        public:
...
public:
    ...
    class mob_necromancerAI : public hyjal_trashAI
    {
        public:
...
public:
    ...
    class mob_bansheeAI : public hyjal_trashAI
    {
        public:
...
public:
    ...
    class mob_crypt_fiendAI : public hyjal_trashAI
    {
        public:
...
public:
    ...
    class mob_fel_stalkerAI : public hyjal_trashAI
    {
        public:
...
public:
    ...
    class mob_frost_wyrmAI : public hyjal_trashAI
    {
        public:
...
public:
    ...
    class mob_gargoyleAI : public hyjal_trashAI
    {
        public:
