...
SD%Complete: 70
SDComment: Missing proper code for patrolling area after being spawned. OLDScript for GO (barrels) quest 10283
...
class BarrelOldHillsbrad : public GameObjectScript
{
public:
