...
public:
    ...
    {
        return new instance_blackfathom_deeps_script(map);
    }

    struct instance_blackfathom_deeps_script : public InstanceScript
    {
        ...
        void OnCreatureCreate(Creature* pCreature, uint32 entry) override
        {
            ...
            case NPC_LORGUS_JETT:
                ...
                pCreature->SetHomePosition(LorgusPosition[posIndex][0], LorgusPosition[posIndex][1], LorgusPosition[posIndex][2], 0);
                break;
            }
        }
