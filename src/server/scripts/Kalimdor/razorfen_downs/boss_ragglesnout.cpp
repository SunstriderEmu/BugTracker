...
class boss_ragglesnout : public CreatureScript
{
public:
    boss_ragglesnout() : CreatureScript("boss_ragglesnout")
    { }

    class boss_ragglesnoutAI : public ScriptedAI
    {
        public:
    ...
    {
        return new boss_ragglesnoutAI(creature);
    }
};
