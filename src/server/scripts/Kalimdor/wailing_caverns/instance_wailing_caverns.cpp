...
public:
    ...
    {
        return new instance_wailing_caverns_script(map);
    }

    struct instance_wailing_caverns_script : public InstanceScript
    {
        instance_wailing_caverns_script(Map* pMap) : InstanceScript(pMap) { Initialize(); };
