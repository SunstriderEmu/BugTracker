...
public:
    ...
    {
        return new instance_zulgurub_script(map);
    }

    struct instance_zulgurub_script : public InstanceScript
    {
        instance_zulgurub_script(Map *map) : InstanceScript(map) { Initialize(); };
