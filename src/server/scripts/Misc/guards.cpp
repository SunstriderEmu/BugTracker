...
bool GossipHello_guard_azuremyst(Player *player, Creature *_Creature)
{
    ...
    player->SEND_GOSSIP_MENU_TEXTID(10066,_Creature->GetGUID());
    return true;
}
...
bool GossipHello_guard_bluffwatcher(Player *player, Creature *_Creature)
{
    ...
    player->SEND_GOSSIP_MENU_TEXTID(3543,_Creature->GetGUID());
    return true;
}
...
bool GossipHello_guard_darnassus(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLASSTRAINER   , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_PROFTRAINER    , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
    player->SEND_GOSSIP_MENU_TEXTID(3016, _Creature->GetGUID());
    return true;
}
...
bool GossipHello_guard_dunmorogh(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLASSTRAINER     , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_PROFTRAINER      , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->SEND_GOSSIP_MENU_TEXTID(4287,_Creature->GetGUID());
...
bool GossipHello_guard_durotar(Player *player, Creature *_Creature)
{
    ...
    player->SEND_GOSSIP_MENU_TEXTID(4037,_Creature->GetGUID());
    return true;
}
...
bool GossipHello_guard_elwynnforest(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLASSTRAINER  , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_PROFTRAINER   , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->SEND_GOSSIP_MENU_TEXTID(933,_Creature->GetGUID());
    return true;
}
...
bool GossipHello_guard_ironforge(Player *player, Creature *_Creature)
{
    ...
    player->SEND_GOSSIP_MENU_TEXTID(2760, _Creature->GetGUID());
    return true;
}
...
bool GossipHello_guard_shattrath_scryer(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALCHEMYLAB                   , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_GEMMERCHANT                  , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
    player->SEND_GOSSIP_MENU_TEXTID(10430, _Creature->GetGUID());
    return true;
}
...
bool GossipHello_guard_teldrassil(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLASSTRAINER , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_PROFTRAINER  , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->SEND_GOSSIP_MENU_TEXTID(4316,_Creature->GetGUID());
    return true;
}
...
bool GossipHello_guard_tirisfal(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLASSTRAINER    , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
    player->ADD_GOSSIP_ITEM( GOSSIP_ICON_CHAT, GOSSIP_TEXT_PROFTRAINER     , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    player->SEND_GOSSIP_MENU_TEXTID(4097,_Creature->GetGUID());
    return true;
}
...
void AddSC_guards()
{
    ...
    newscript->OnGossipHello          = &GossipHello_guard_azuremyst;
    newscript->OnGossipSelect         = &GossipSelect_guard_azuremyst;
    newscript->GetAI = &GetAI_guard_azuremyst;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_bluffwatcher";
    newscript->OnGossipHello          = &GossipHello_guard_bluffwatcher;
    newscript->OnGossipSelect         = &GossipSelect_guard_bluffwatcher;
    ...
    newscript->OnGossipHello          = &GossipHello_guard_darnassus;
    newscript->OnGossipSelect         = &GossipSelect_guard_darnassus;
    newscript->GetAI = &GetAI_guard_darnassus;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_dunmorogh";
    newscript->OnGossipHello          = &GossipHello_guard_dunmorogh;
    newscript->OnGossipSelect         = &GossipSelect_guard_dunmorogh;
    newscript->GetAI = &GetAI_guard_dunmorogh;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_durotar";
    newscript->OnGossipHello          = &GossipHello_guard_durotar;
    newscript->OnGossipSelect         = &GossipSelect_guard_durotar;
    newscript->GetAI = &GetAI_guard_durotar;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_elwynnforest";
    newscript->OnGossipHello          = &GossipHello_guard_elwynnforest;
    newscript->OnGossipSelect         = &GossipSelect_guard_elwynnforest;
    newscript->GetAI = &GetAI_guard_elwynnforest;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_eversong";
    newscript->OnGossipHello          = &GossipHello_guard_eversong;
    newscript->OnGossipSelect         = &GossipSelect_guard_eversong;
    newscript->GetAI = &GetAI_guard_eversong;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_exodar";
    newscript->OnGossipHello          = &GossipHello_guard_exodar;
    newscript->OnGossipSelect         = &GossipSelect_guard_exodar;
    newscript->GetAI = &GetAI_guard_exodar;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_ironforge";
    newscript->OnGossipHello          = &GossipHello_guard_ironforge;
    newscript->OnGossipSelect         = &GossipSelect_guard_ironforge;
    newscript->GetAI = &GetAI_guard_ironforge;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_mulgore";
    newscript->OnGossipHello          = &GossipHello_guard_mulgore;
    newscript->OnGossipSelect         = &GossipSelect_guard_mulgore;
    newscript->GetAI = &GetAI_guard_mulgore;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_orgrimmar";
    newscript->OnGossipHello          = &GossipHello_guard_orgrimmar;
    newscript->OnGossipSelect         = &GossipSelect_guard_orgrimmar;
    newscript->OnReceiveEmote         = &ReceiveEmote_guard_orgrimmar;
    newscript->GetAI = &GetAI_guard_orgrimmar;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_shattrath";
    newscript->OnGossipHello          = &GossipHello_guard_shattrath;
    newscript->OnGossipSelect         = &GossipSelect_guard_shattrath;
    ...
    newscript->OnGossipHello          = &GossipHello_guard_shattrath_aldor;
    newscript->OnGossipSelect         = &GossipSelect_guard_shattrath_aldor;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_shattrath_scryer";
    newscript->GetAI = &GetAI_guard_shattrath_scryer;
    newscript->OnGossipHello          = &GossipHello_guard_shattrath_scryer;
    newscript->OnGossipSelect         = &GossipSelect_guard_shattrath_scryer;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_silvermoon";
    newscript->OnGossipHello          = &GossipHello_guard_silvermoon;
    newscript->OnGossipSelect         = &GossipSelect_guard_silvermoon;
    newscript->GetAI = &GetAI_guard_silvermoon;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_stormwind";
    newscript->OnGossipHello          = &GossipHello_guard_stormwind;
    newscript->OnGossipSelect         = &GossipSelect_guard_stormwind;
    newscript->OnReceiveEmote         = &ReceiveEmote_guard_stormwind;
    newscript->GetAI = &GetAI_guard_stormwind;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_teldrassil";
    newscript->OnGossipHello          = &GossipHello_guard_teldrassil;
    newscript->OnGossipSelect         = &GossipSelect_guard_teldrassil;
    newscript->GetAI = &GetAI_guard_teldrassil;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_tirisfal";
    newscript->OnGossipHello          = &GossipHello_guard_tirisfal;
    newscript->OnGossipSelect         = &GossipSelect_guard_tirisfal;
    newscript->GetAI = &GetAI_guard_tirisfal;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="guard_undercity";
    newscript->OnGossipHello          = &GossipHello_guard_undercity;
    newscript->OnGossipSelect         = &GossipSelect_guard_undercity;
