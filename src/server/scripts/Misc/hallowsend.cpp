...
class npc_fire_effigy_fire : public CreatureScript
{
public:
    npc_fire_effigy_fire() : CreatureScript("npc_fire_effigy_fire")
    { }

    class npc_fire_effigy_fireAI : public ScriptedAI
    {
        public:
            npc_fire_effigy_fireAI(Creature* c) : ScriptedAI(c)
        {
    ...
    {
        return new npc_fire_effigy_fireAI(creature);
    }
};
...
public:
    ...
    struct WickermanEmberAI : public GameObjectAI
    {
        WickermanEmberAI(GameObject* obj) : GameObjectAI(obj) { }
    ...
    {
        return new WickermanEmberAI(go);
    }
};
...
class boss_shade_of_horseman : public CreatureScript
{
public:
    boss_shade_of_horseman() : CreatureScript("boss_shade_of_horseman")
    { }

    class boss_shade_of_horsemanAI : public ScriptedAI
    {
        public:
...
class npc_shade_of_horseman_bunny : public CreatureScript
{
public:
    npc_shade_of_horseman_bunny() : CreatureScript("npc_shade_of_horseman_bunny")
    { }

    class npc_shade_of_horseman_bunnyAI : public ScriptedAI
    {
        public:
        ...
        override {
            if (spellId == SPELL_THROW_FLAME) {
                ...
                if (Creature* shade = ObjectAccessor::GetCreature(*me, shadeGUID))
                    ((boss_shade_of_horseman::boss_shade_of_horsemanAI*)shade->AI())->flamesCount--;
...
void AddSC_hallows_end()
{
    ...
    new npc_fire_effigy_fire();
    
    new WickermanEmber();
    
    new boss_shade_of_horseman();
    
    new npc_shade_of_horseman_bunny();
}    
