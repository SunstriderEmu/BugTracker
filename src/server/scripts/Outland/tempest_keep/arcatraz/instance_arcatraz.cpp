...
public:
    ...
    {
        instance_arcatraz_script(Map *map) : InstanceScript(map) { Initialize(); };
        ...
        void Initialize()
            override {
            Containment_Core_Security_Field_Alpha = nullptr;
            Containment_Core_Security_Field_Beta = nullptr;
            Pod_Alpha = nullptr;
            Pod_Beta = nullptr;
            Pod_Delta = nullptr;
            Pod_Gamma = nullptr;
            Pod_Omega = nullptr;
            Wardens_Shield = nullptr;
