...
enum Spells
{
    ...
    SPELL_GIFT_OF_THE_DOOMSAYER_H   = 39009,
    ...
    public:
        ...
        struct boss_dalliah_the_doomsayerAI : public BossAI
        {
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_GIFT_OF_THE_DOOMSAYER:
                            DoCastVictim(IsHeroic() ? SPELL_GIFT_OF_THE_DOOMSAYER_H : SPELL_GIFT_OF_THE_DOOMSAYER, true);
                        ...
                        case EVENT_WHIRLWIND:
                            ...
                            break;
                        case EVENT_HEAL:
                            DoCast(me, IsHeroic() ? SPELL_HEAL_H : SPELL_HEAL);
                            Talk(SAY_HEAL);
                            break;
                ...
                if (me->HealthBelowPct(25) && !soccothratesTaunt)
                {
                    if (Creature* soccothrates = ObjectAccessor::GetCreature(*me, instance->GetGuidData(DATA_SOCCOTHRATES)))
