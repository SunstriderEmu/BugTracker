...
void AddSC_netherstorm()
{
    ...
    newscript->OnGossipHello =   &GossipHello_npc_protectorate_nether_drake;
    newscript->OnGossipSelect =  &GossipSelect_npc_protectorate_nether_drake;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name = "npc_professor_dabiri";
    newscript->OnGossipHello =   &GossipHello_npc_professor_dabiri;
    newscript->OnGossipSelect =  &GossipSelect_npc_professor_dabiri;
    newscript->OnQuestAccept = &QuestAccept_npc_professor_dabiri;
    sScriptMgr->RegisterOLDScript(newscript);

    newscript = new OLDScript;
    newscript->Name="npc_veronia";
    newscript->OnGossipHello =   &GossipHello_npc_veronia;
    newscript->OnGossipSelect =  &GossipSelect_npc_veronia;
    sScriptMgr->RegisterOLDScript(newscript);
    ...
    newscript->OnQuestAccept = &QuestAccept_npc_bessy;
    sScriptMgr->RegisterOLDScript(newscript);
    
    newscript = new OLDScript;
    newscript->Name = "npc_maxx_a_million_escort";
    newscript->GetAI = &GetAI_npc_max_a_million_escort;
    newscript->OnQuestAccept = &QuestAccept_npc_max_a_million_escort;
    sScriptMgr->RegisterOLDScript(newscript);
    ...
    newscript->OnQuestAccept = &QuestAccept_npc_drijya;
    sScriptMgr->RegisterOLDScript(newscript);
}
