...
public:
    ...
    class mob_naga_distillerAI : public ScriptedAI
    {
        public:
...
public:
    ...
    class boss_warlord_kalithreshAI : public ScriptedAI
    {
        public:
                ...
                if (Aura* aur = me->GetAura(36453, 0))
                {
                    if (aur->GetStackAmount() < 10)
                    {
                        ...
                        if (distiller)
                        {
                            ...
                            ((mob_naga_distiller::mob_naga_distillerAI*)distiller->AI())->StartRageGen(me);
                        }
                    }
                }
                else
