...
public:
    ...
    class boss_fathomlord_karathressAI : public ScriptedAI
    {
        public:
...
public:
    ...
    class boss_fathomguard_sharkkisAI : public ScriptedAI
    {
        public:
...
public:
    ...
    class boss_fathomguard_tidalvessAI : public ScriptedAI
    {
        public:
...
public:
    ...
    class boss_fathomguard_caribdisAI : public ScriptedAI
    {
        public:
        ...
        override {
            if (pInstance)
            {
                ...
                if (Karathress)
                    if(!me->IsAlive() && Karathress)
                        ((boss_fathomlord_karathress::boss_fathomlord_karathressAI*)Karathress->AI())->EventCaribdisDeath();
            }
        }
