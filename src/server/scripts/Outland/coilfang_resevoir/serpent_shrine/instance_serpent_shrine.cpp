...
class BridgeConsole : public GameObjectScript
{
public:
...
class instance_serpentshrine_cavern : public InstanceMapScript
{
public:
    instance_serpentshrine_cavern() : InstanceMapScript("instance_serpent_shrine", 548) { }

    InstanceScript* GetInstanceScript(InstanceMap* map) const override
    {
        return new instance_serpentshrine_cavern_script(map);
    }

    struct instance_serpentshrine_cavern_script : public InstanceScript
    {
        ...
        void Update(uint32 diff) override
        {
            ...
            if (WaterCheckTimer < diff)
            {
                ...
                if (GetData(DATA_THELURKERBELOWEVENT) != DONE)
                {
                    ...
                    {
                        if (GameObject *Console = instance->GetGameObject(SerpentshrineConsole))
...
{
    new instance_serpentshrine_cavern();
    new BridgeConsole();
}
